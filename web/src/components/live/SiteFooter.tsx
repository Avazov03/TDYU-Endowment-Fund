...
export function SiteFooter({ locale }: { locale: Locale }) {
  ...
  return (
    <footer className="bg-tdyu text-white/85 pt-14">
      <div className="live-wrap grid gap-10 pb-10 md:grid-cols-4">
        ...
        <div>
          ...
          <div className="grid gap-2 text-sm">
            <Link href="/about-us">{copy.mission}</Link>
      ...
      <div className="border-t border-white/15 text-center text-sm text-white/55 py-4">
        © {new Date().getFullYear()} TDYU Endowment Fund
      </div>
    </footer>
  )
}
