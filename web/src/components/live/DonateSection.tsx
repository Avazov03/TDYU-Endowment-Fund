...
const COPY = {
  uz: {
    eyebrow: 'Xayriya qilish',
    title: 'Xayriya va qo‘llab-quvvatlash',
    formTitle: 'Xayriya / aloqa formasi',
  },
  ru: {
    eyebrow: 'Пожертвовать',
    title: 'Пожертвования и поддержка',
    formTitle: 'Форма пожертвования / связи',
  },
  en: {
    eyebrow: 'Donate',
    title: 'Donations and support',
    formTitle: 'Donation / contact form',
  },
} as const
...
export function DonateSection({ locale }: { locale: Locale }) {
  ...
  return (
    <section className="donate-section relative bg-white" id="home-donate" aria-labelledby="donate-section-heading">
      <Image
        src="/media/home/contact-shape.png"
        alt=""
        width={200}
        height={200}
        className="donate-section-shape pointer-events-none absolute hidden lg:block"
        unoptimized
      />

      <div className="live-wrap donate-section-inner relative z-10 px-2.5 lg:px-5">
        <div className="donate-section-stage">
          <div className="donate-section-heading">
            <p className="donate-section-eyebrow">
              <EyebrowIcon />
              {t.eyebrow}
            </p>
            <h2 id="donate-section-heading" className="donate-section-title">
              {t.title}
            </h2>
          </div>

          <div className="donate-section-banner-wrap">
            <div className="donate-section-banner">
              <Image
                src="/media/home/contact-img.png"
                alt=""
                width={355}
                height={520}
                className="donate-section-student"
                sizes="(max-width: 1024px) 60vw, 355px"
                unoptimized
              />
            </div>
          </div>
          ...
          <div className="donate-section-card">
            <h3 className="donate-section-form-title">{t.formTitle}</h3>
            <HomeDonateForm />
          </div>
        </div>
      </div>
