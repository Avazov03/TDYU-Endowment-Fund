...
const TABS = [
  {
    ...
    images: [
      '/media/dump/gov/gallery-img5-5-min.jpg',
      '/media/dump/gov/gallery-img-5.jpg',
      '/media/dump/gov/gallery-img4-min.jpg',
      '/media/dump/gov/gallery-img3-min.jpg',
      '/media/dump/gov/gallery-img-6.jpg',
      '/media/dump/gov/gallery-img2-min.jpg',
    ],
  },
  {
    id: 'bk',
    ...
    images: [
      '/media/dump/gov/gallery-img-6.jpg',
      '/media/dump/gov/gallery-img4-min.jpg',
      '/media/dump/gov/gallery-img-1.jpg',
      '/media/dump/gov/gallery-img2-min.jpg',
      '/media/dump/gov/gallery-img3-min.jpg',
      '/media/dump/gov/gallery-img-5.jpg',
    ],
  ...
  },
  {
    ...
    images: [
      '/media/dump/gov/gallery-img-3.jpg',
      '/media/dump/gov/gallery-img-4.jpg',
      '/media/dump/gov/gallery-img-1.jpg',
      '/media/dump/gov/gallery-img6-min.jpg',
      '/media/dump/gov/gallery-img-2.jpg',
      '/media/dump/gov/gallery-img1-min.jpg',
    ],
  },
] as const
