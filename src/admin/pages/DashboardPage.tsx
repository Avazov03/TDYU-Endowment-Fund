    ...
    <>
      <div className="admin-top">
        ...
        <div className="toolbar">
          ...
          <Link className="btn ghost" to="/admin/documents">
            Hujjat yuklash
          </Link>
          <Link className="btn ghost" to="/admin/announcements">
            + E’lon
          </Link>
          <a className="btn" href="/cyan/index.html" target="_blank" rel="noreferrer">
            Saytni ko‘rish
          </a>
        </div>
      </div>
      ...
      <div className="cards">
        <Link className="stat-card" to="/admin/contacts">
        ...
        <Link className="stat-card" to="/admin/donations">
        ...
        <Link className="stat-card" to="/admin/announcements">
          <div className="stat-icon">☰</div>
      ...
      <div className="dash-grid">
        <div className="panel">
          <div className="panel-head">
            ...
            <Link className="meta" to="/admin/contacts">
              Barchasi
            </Link>
          </div>
          {!contacts.length ? (
        ...
        <div className="panel">
          ...
          <div className="panel-head" style={{ borderTop: '1px solid var(--tdyu-line)' }}>
            ...
            <Link className="meta" to="/admin/donations">
              Barchasi
            </Link>
          </div>
          {!donations.length ? (
          ...
          <div className="panel-head" style={{ borderTop: '1px solid var(--tdyu-line)' }}>
            ...
            <Link className="meta" to="/admin/grants">
              Barchasi
            </Link>
          </div>
          {!grants.length ? (
